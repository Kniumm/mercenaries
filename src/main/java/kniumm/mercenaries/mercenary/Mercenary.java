...
public class Mercenary extends AbstractArmedVillager implements CrossbowAttackMob, InventoryCarrier, NeutralMob {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, Ravager.class, false));
        this.targetSelector.addGoal(3, (new HurtByTargetGoal(this, AbstractVillager.class)).setAlertOthers());
